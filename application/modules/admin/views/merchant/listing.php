...
<head>
    <meta charset="utf-8" />
    <title>
        <?php echo $this->site_name; ?> | Merchant List
    </title>
                            ...
                            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                        <a href="<?php echo site_url('admin/merchant/add');?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                            <span>
    ...
    var t = function() {
        var t = $(".m_datatable").mDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: "<?php echo site_url('admin/merchant/ajax_list')?>"
                    }
                },
                pageSize: 10,
                saveState: {
            ...
            template: function(t) {
                ...
                return '<span class="m-badge m-badge--' + e[t.is_verified].state + ' m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-' + e[t.is_verified].state + '">' + e[t.is_verified].title + "</span>"
            }
        }, {
            field: "status",
            title: "Status",
            ...
            overflow: "visible",
            template: function(t) {
                return '\t\t\t\t\t\t<a href="<?php echo base_url()."admin/merchant/view/";?>'+t.encode_id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill" title="View">\t\t\t\t\t\t\t<i class="la la-eye"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t<a href="<?php echo base_url()."admin/merchant/edit/";?>'+t.encode_id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>'
            }
        }]
    }),
...
function change_state(id,status) 
{
    swal({   
        ...
        $.ajax({
            url:  "<?php echo site_url();?>admin/merchant/merchant_state/"+id+"/"+status,
            type: "GET",
            success: function(data)
            {
                ...
                m_datatables.reload();
                //DatatableRemoteAjaxDemo.init();
                //window.location.href = "<?php echo base_url()."admin/merchant/listing"; ?>"
            },
