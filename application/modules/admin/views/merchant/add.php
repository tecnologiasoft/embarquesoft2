...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | Add New Merchant 
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('admin/merchant/add/',$form_data); 
                        ?>
                            <div class="row">
                                    ...
                                    <div class="m-portlet m-portlet--tab">
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="fname" id="fname" placeholder="Enter your first name" value="<?php echo set_value('fname'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="lname" id="lname" placeholder="Enter your last name" value="<?php echo set_value('lname'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="email" class="form-control m-input" name="email" id="email" placeholder="Enter your email" value="<?php echo set_value('email'); ?>" >
