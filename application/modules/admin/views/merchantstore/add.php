...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | Add New Merchant Store 
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('admin/merchantstore/add/',$form_data); 
                        ?>
                            <div class="row">
                                    ...
                                    <div class="m-portlet m-portlet--tab">
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <select class="form-control m-input" name="merchant_id" id="merchant_id">
                                                    ...
                                                    foreach ($merchant_list as $row){  ?>
                                                        <option value="<?php echo $row['id']; ?>" <?php echo set_select('merchant_id',$row['id']); ?> > <?php echo $row['fname'].' '.$row['lname']; ?> </option>
                                                    <?php } } ?>
                                                </select>
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="store_name" id="store_name" placeholder="Enter your store name" value="<?php echo set_value('store_name'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="contact_name" id="contact_name" placeholder="Enter your contact name" value="<?php echo set_value('contact_name'); ?>" >
                                            ...
                                            <!-- <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group m-form__group">
                                                        ...
                                                        <input type="text" class="form-control m-input" name="country_code" id="country_code" placeholder="+00" value="<?php echo set_value('country_code'); ?>"  >
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group m-form__group">
                                                        ...
                                                        <input type="text" class="form-control m-input" name="phone" id="phone" placeholder="Enter your phone number" value="<?php echo set_value('phone'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="contact_phone" id="contact_phone" placeholder="Enter your contact phone" value="<?php echo set_value('contact_phone'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="address" id="address" placeholder="Enter your address" value="<?php echo set_value('address'); ?>" >
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group m-form__group">
                                                        ...
                                                        <input type="text" class="form-control m-input" name="latitude" id="latitude" placeholder="Enter your latitude" value="<?php echo set_value('latitude'); ?>"  >
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group m-form__group">
                                                        ...
                                                        <input type="text" class="form-control m-input" name="longitude" id="longitude" placeholder="Enter your longitude" value="<?php echo set_value('longitude'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <input type="text" class="form-control m-input" name="website" id="website" placeholder="http://" value="<?php echo set_value('website'); ?>" >
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <textarea class="form-control m-input" name="about" id="about" placeholder="Enter a about"><?php echo set_value('about'); ?></textarea>
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <?php echo form_error('store_banner'); echo $error_msg1; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end::Portlet-->
