...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_edit_claims'); ?>
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_edit_claims'); ?>
                                </h3>
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('company/claims/edit/'.$result['id'],$form_data); 
                        ?>  
                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label col-form-label-right">
                                                        * <?php echo $this->lang->line('label_claim_id'); ?>:
                                                    </label>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="claim_date" id="claim_date" placeholder="<?php echo $this->lang->line('label_claim_date'); ?>" value="<?php if(!empty($result['claim_date'])) echo $result['claim_date']; else echo set_value('claim_date'); ?>" maxlength="64">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="invoice_number" id="invoice_number" placeholder="<?php echo $this->lang->line('label_invoice_number'); ?>" value="<?php if(!empty($result['invoice_number'])) echo $result['invoice_number']; else echo set_value('invoice_number'); ?>" maxlength="16">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="m-radio-inline">
                                                            <label class="m-radio">
                                                                <input name="status" value="Open" type="radio" <?php if($result['status'] == "Open") echo "checked"; ?>>
                                                                <?php echo $this->lang->line('label_open'); ?>
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="status" value="Processing" type="radio"  <?php if($result['status'] == "Processing") echo "checked"; ?>>
                                                                <?php echo $this->lang->line('label_processing'); ?>
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="status" value="Closed" type="radio"  <?php if($result['status'] == "Closed") echo "checked"; ?>>
