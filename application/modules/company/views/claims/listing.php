                                            ...
                                            <div class="form-group m-form__group row align-items-center">
                                                ...
                                                <div class="col-xl-2 order-1 order-xl-2 m--align-right">
                                                    ...
                                                    <option value = ""><?php echo $this->lang->line('label_status'); ?></option>
                                                      <option value = "Open"><?php echo $this->lang->line('label_open'); ?></option>
                                                      <option value = "Processing"><?php echo $this->lang->line('label_processing'); ?></option>
                                                      <option value = "Closed"><?php echo $this->lang->line('label_closed'); ?></option>
                                                    </select>
                                                    <div class="m-separator m-separator--dashed d-xl-none"></div>
                                                </div>

                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                    <a href="<?php echo site_url('company/claims/add');?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                        <span>
                                                            <i class="la la-plus"></i> 
                                                            <span>
                                                                <?php echo $this->lang->line('label_add_claims'); ?>
                                                            </span>
                                                        </span>
                                                    </a>
                                                    <div class="m-separator m-separator--dashed d-xl-none"></div>
        ...
        <script type="text/javascript">
            ...
            var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "<?php echo site_url('company/claims/ajax_list')?>"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    field: "claim_date",
                    title: "<?php echo $this->lang->line('label_claim_date'); ?>",
                }, {
                    field: "name",
                    ...
                    field: "created_date",
                    title: "<?php echo $this->lang->line('label_created_date'); ?>",
                },
                {
                    field: "updated_date",
                    title: "<?php echo $this->lang->line('label_updated_date'); ?>",
                },
                {
                    field: "creator",
                    title: "<?php echo $this->lang->line('label_created_by'); ?>",
                },
                {
                    field: "status",
                ...
                },
                {
                    ...
                    overflow: "visible",
                    template: function(t) {
                        /*\t\t\t\t\t\t<a href="<?php echo base_url()."company/claims/view/";?>'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-eye"></i>\t\t\t\t\t\t</a>*/
                        return '\t\t\t\t\t\t\t\t\t\t\t<a href="<?php echo base_url()."company/claims/edit/";?>'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t<a href="javascript:;" onclick="delete_claim('+t.id+')" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" >\t\t\t\t\t\t\t<i class="la la-trash"></i>\t\t\t\t\t\t</a>'
                    }
                }]
            }),
            ...
            function delete_claim(id) 
            {
                swal({   
                    ...
                    text: "<?php echo $this->lang->line('label_you_want_to_delete_claim') ?>",
                    type: "warning",   
                    ...
                    $.ajax({
                        url:  "<?php echo base_url(); ?>company/claims/delete/"+id,
                        type: "GET",
