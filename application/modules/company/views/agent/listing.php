                                        ...
                                        <div class="col-xl-8 order-2 order-xl-1">
                                            <div class="form-group m-form__group row align-items-center">
                                                ...
                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                    <a href="<?php echo site_url('company/agent/add');?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                        <span>
                                                            <i class="la la-user-plus"></i> 
                                                            <span>
                                                                <?php echo $this->lang->line('label_add_agent'); ?>
                                                            </span>
                                                        </span>
                                                    </a>
        ...
        <script type="text/javascript">
            ...
            var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "<?php echo site_url('company/agent/ajax_list')?>"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    field: "email",
                    title: "<?php echo $this->lang->line('label_email'); ?>",
                }, {
                    field: "address_1",
                    ...
                    field: "agent_company",
                    title: "<?php echo $this->lang->line('label_agent_company'); ?>",
                },
                {
                    field: "Actions",
                    width: 110,
            ...
            function delete_agent(id) 
            {
                swal({   
                    ...
                    text: "<?php echo $this->lang->line('label_you_want_to_delete_agent') ?>",
                    type: "warning",   
                    ...
                    $.ajax({
                        url:  "<?php echo base_url(); ?>company/agent/delete/"+id,
                        type: "GET",
