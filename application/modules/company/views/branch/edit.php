                                ...
                                ?>
                                  ...
                                  <!--end: Search Form -->
                                     ...
                                     <!-- <form method="post" role="form" id="BaschTran">
                                      ...
                                      <input type="text" class="form-control m-input" name="date" id="date" placeholder="<?php echo $this->lang->line('label_date'); ?>" value="<?php echo $list['invoice_number']?$list['invoice_number']:set_value('invoice_number')?>">
                                      <?php echo form_error('date'); ?>
     ...
     <!--end::Form-->
       ...
       <div class="col-sm-4">
                   <form method="post" role="form" id="BaschTran">
                      ...
                      <input type="text" class="form-control m-input" name="id" id="id" placeholder="<?php echo $this->lang->line('label_id'); ?>" value="<?php echo $result['invoice_number']?$result['invoice_number']:set_value('invoice_number')?>">
                ...
                columns: [{
                    ...
                    template: function() {
                       // return '\t\t\t\t\t\t\t\t\t\t\t<input class="montoBalance" name="'+t.balance+'" value="'+t.balance+'" type="text">'
                        return '\t\t\t\t\t\t\t\t\t\t\t<span class="exchange_balance" style="width: 138px;">AA</span>'
                    }
                },{
