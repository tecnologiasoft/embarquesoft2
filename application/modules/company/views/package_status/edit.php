...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_edit_package_status'); ?>
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_edit_package_status'); ?>
                                </h3>
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('company/package_status/edit/'.$result['id'],$form_data); 
                        ?>  
                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label col-form-label-right">
                                                        * <?php echo $this->lang->line('label_package_status_id'); ?>:
                                                    </label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="package_status_id" id="package_status_id" placeholder="<?php echo $this->lang->line('label_package_status_id'); ?>" value="<?php if(!empty($result['id'])) echo $result['id']; else echo set_value('package_status_id'); ?>" disabled >
                                                        <?php echo form_error('package_status_id'); ?>
                                                    </div>
                                                </div> 
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label col-form-label-right">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <!-- <input type="text" class="form-control m-input" name="warehouse_id" id="warehouse_id" placeholder="<?php echo $this->lang->line('label_warehouse_id'); ?>" value="<?php if(!empty($result['warehouse_id'])) echo $result['warehouse_id']; echo set_value('warehouse_id'); ?>" > -->
                                                        <select class="form-control m-input" name="warehouse_id" id="warehouse_id" placeholder="<?php echo $this->lang->line('label_warehouse_id'); ?>">
                                                            ...
                                                            ?>
                                                                        <option value="<?php echo $value['id']; ?>" <?php if(!empty($result['warehouse_id']) && $result['warehouse_id'] == $value['id']) echo "selected"; ?>><?php echo $value['name']; ?></option>
                                                            <?php
                                                                    }
                                                                }
                                                            ?>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <select class="form-control m-input" name="tran_type" id="tran_type" placeholder="<?php echo $this->lang->line('label_transaction_type'); ?>">
                                                            ...
                                                            <option value="Warehouse" <?php if($result['tran_type'] == "Warehouse") echo "selected"; ?>><?php echo $this->lang->line('label_warehouse'); ?></option>
                                                            <option value="Transit"  <?php if($result['tran_type'] == "Transit") echo "selected"; ?>><?php echo $this->lang->line('label_transit'); ?></option>
                                                            <option value="Container" <?php if($result['tran_type'] == "Container") echo "selected"; ?>><?php echo $this->lang->line('label_container'); ?></option>
                                                            <option value="Delivery" <?php if($result['tran_type'] == "Delivery") echo "selected"; ?>><?php echo $this->lang->line('label_delivery'); ?></option>
                                                        </select>
                                                ...
                                                <!-- <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="m-radio-inline">
                                                            <label class="m-radio">
                                                                <input name="active" value="Yes" type="radio" <?php if($result['active'] == "Yes") echo "checked"; ?>>
                                                                <?php echo $this->lang->line('label_yes'); ?>
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="active" value="No" type="radio" <?php if($result['active'] == "No") echo "checked"; ?>>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="m-radio-inline">
                                                            <label class="m-radio">
                                                                <input name="clear_warehouse" value="Yes" type="radio" <?php if($result['clear_warehouse'] == "Yes") echo "checked"; ?>>
                                                                <?php echo $this->lang->line('label_yes'); ?>
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="clear_warehouse" value="No" type="radio" <?php if($result['clear_warehouse'] == "No") echo "checked"; ?>>
                                                                <?php echo $this->lang->line('label_no'); ?>
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="scanner_country" id="scanner_country" placeholder="<?php echo $this->lang->line('label_scanner_country'); ?>" value="<?php if(!empty($result['scanner_country'])) echo $result['scanner_country']; else echo set_value('scanner_country'); ?>" >
