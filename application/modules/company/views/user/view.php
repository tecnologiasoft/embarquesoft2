...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			<?php echo $this->site_name; ?>  | <?php echo $this->lang->line('title_view_user'); ?>
		</title>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_view_user'); ?>
                                </h3>
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="<?php echo site_url();?>company/user/listing" class="m-nav__link">
									...
									<div class="m-portlet__body ">
										<div class="m-form__section m-form__section--first">
											<div class="m-form m-form--fit m-form--label-align-right">
												...
												<div class="form-group m-form__group row">
	                                                <label class="col-xl-3 col-lg-3 col-form-label col-form-label-right">
														<?php echo $this->lang->line('label_user_group'); ?> :
													</label>
	                                                <label class="col-xl-9 col-lg-9 col-form-label text-left">
	                                                	<?php echo $result['user_group'];?>
	                                                </label>
												</div> 
												<!-- <div class="form-group m-form__group row">
	                                                <label class="col-xl-3 col-lg-3 col-form-label col-form-label-right">
												...
												<div class="form-group m-form__group row">
	                                                ...
	                                                <label class="col-xl-9 col-lg-9 col-form-label text-left">
	                                                	<?php 
	                                                		if($result['start_time'] != "00:00:00"){
	                                                			echo $this->common->from_date_convert($result['start_time'], 'UTC', $this->session->userdata('web_timezone'), 'h:i A'); 
	                                                		}
                                                		 ?>
	                                                </label>
												</div>
												<div class="form-group m-form__group row">
	                                                ...
	                                                <label class="col-xl-9 col-lg-9 col-form-label text-left">
	                                                	<?php 
	                                                		if($result['end_time'] != "00:00:00"){
	                                                			echo $this->common->from_date_convert($result['end_time'], 'UTC', $this->session->userdata('web_timezone'), 'h:i A');
	                                                		}
                                                		 ?>
	                                                </label>
												</div> 
