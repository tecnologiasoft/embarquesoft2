                                        ...
                                        <div class="col-xl-8 order-2 order-xl-1">
                                            <div class="form-group m-form__group row align-items-center">
                                                ...
                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                    <a href="<?php echo $this->rights->access('company/user/add'); ?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                        <span>
                                                            <i class="la la-user-plus"></i> 
                                                            <span>
                                                                <?php echo $this->lang->line('label_add_user'); ?>
                                                            </span>
                                                        </span>
                                                    </a>
        ...
        <script type="text/javascript">
            ...
            var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "<?php echo site_url('company/user/ajax_list')?>"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    field: "user_name",
                    title: "<?php echo $this->lang->line('label_user_name'); ?>",
                }, {
                    field: "address",
                    ...
                    field: "container",
                    title: "<?php echo $this->lang->line('label_container'); ?>",
                },
                {
                    field: "Actions",
                    width: 110,
                    ...
                    overflow: "visible",
                    template: function(t) {
                        /*\t\t\t\t\t\t<a href="<?php echo base_url()."company/user/view/";?>'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-eye"></i>\t\t\t\t\t\t</a>*/
                        <?php if($this->rights->access('company/user/add') != 'javascript:void(0);') {?>
                        return '\t\t\t\t\t\t\t\t\t\t\t<a href="<?php echo base_url()."company/user/edit/";?>'+t.master_user_id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t<a href="javascript:;" onclick="delete_user('+t.master_user_id+')" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" >\t\t\t\t\t\t\t<i class="la la-trash"></i>\t\t\t\t\t\t</a>'
                        <?php } ?>
                    }
                }]
            }),
            ...
            function delete_user(id) 
            {
                swal({   
                    ...
                    text: "<?php echo $this->lang->line('label_you_want_to_delete_user') ?>",
                    type: "warning",   
                    ...
                    $.ajax({
                        url:  "<?php echo base_url(); ?>company/user/delete/"+id,
                        type: "GET",
