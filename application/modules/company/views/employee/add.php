                        ...
                        <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="row mb-3">
                                 ...
                                 * <?php echo $this->lang->line('label_first_name'); ?>:
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="first_name" id="first_name" placeholder="<?php echo $this->lang->line('label_first_name'); ?>" value="<?=$result['first_name']?$result['first_name']:set_value('first_name')?>">
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="address1" id="address1" placeholder="<?php echo $this->lang->line('field_address_line_1'); ?>" value="<?=@$result['address1']?$result['address1']:set_value('address1')?>">
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="address2" id="address2" placeholder="<?php echo $this->lang->line('field_address_line_2'); ?>" value="<?=$result['address2']?$result['address2']:set_value('address2')?>" >
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="city" id="city" placeholder="<?php echo $this->lang->line('label_city'); ?>" value="<?=$result['city']?$result['city']:set_value('city')?>">
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="state" id="state" placeholder="<?php echo $this->lang->line('label_state'); ?>" value="<?=@$result['state']?$result['state']:set_value('state')?>">
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="zipcode" id="zipcode" placeholder="<?php echo $this->lang->line('label_zipcode'); ?>" value="<?=@$result['zipcode']?$result['zipcode']:set_value('zipcode')?>" >
                              ...
                              <div class="row mb-3">
                                 ...
                                 * <?php echo $this->lang->line('label_telephone'); ?>:
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="telephone" id="telephone" placeholder="<?php echo $this->lang->line('label_telephone'); ?>" value="<?=@$result['tel']?$result['tel']:set_value('telephone')?>" >
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="cel" id="cellphone_number" placeholder="<?php echo $this->lang->line('label_cellphone'); ?>" value="<?=@$result['cel']?$result['cel']:set_value('cel')?>" >
                           ...
                           <div class="col-lg-6">
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="email" id="email" placeholder="<?php echo $this->lang->line('label_email'); ?>" value="<?=@$result['email']?$result['email']:set_value('email')?>" maxlength="128" >
                              ...
                              <div class="row mb-3">
                                 ...
                                 * <?php echo $this->lang->line('label_country'); ?>:
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="country" id="country" placeholder="<?php echo $this->lang->line('label_country'); ?>" value="<?php echo set_value('country')?et_value('country'):$result['country']; ?>" >
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <div class="m-radio-inline">
                                       <label class="m-radio">
                                       <input name="is_warehouse" value="1" type="radio" <?php echo $result['is_warehouse'] == "1" ? "checked":""; ?>>
                                       <?php echo $this->lang->line('label_yes'); ?>
                                       <span></span>
                                       </label>
                                       <label class="m-radio">
                                       <input name="is_warehouse" value="0" type="radio" 
                                       <?php echo ($result['is_warehouse'] == "0" ? "checked":(isset($result['is_warehouse']) ?"":"checked")); ?>>
                              ...
                              <div class="row mb-3">
                                 ...
                                 <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control m-input" name="social_security" id="social_security" placeholder="<?php echo $this->lang->line('field_social_security'); ?>" value="<?=@$result['social_security']?$result['social_security']:set_value('factor_of_volume')?>" >
