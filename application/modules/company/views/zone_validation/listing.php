...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_zone_validation_list'); ?>
        </title>
                            ...
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="<?php echo site_url();?>company/zone_validation/listing" class="m-nav__link">
                                        ...
                                        <div class="col-xl-8 order-2 order-xl-1">
                                            <div class="form-group m-form__group row align-items-center">
                                                ...
                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                    <a href="<?php echo site_url('company/zone_validation/add');?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                        <span>
                                                            <i class="la la-plus"></i> 
                                                            <span>
                                                                <?php echo $this->lang->line('label_add_zone_validation'); ?>
                                                            </span>
                                                        </span>
                                                    </a>
        ...
        <script type="text/javascript">
            ...
            var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "<?php echo site_url('company/zone_validation/ajax_list')?>"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    field: "zip",
                    title: "<?php echo $this->lang->line('label_zipcode'); ?>",
                },
                {
                    field: "Actions",
                    width: 110,
                    ...
                    overflow: "visible",
                    template: function(t) {
                        /*\t\t\t\t\t\t<a href="<?php echo base_url()."company/zone_validation/view/";?>'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-eye"></i>\t\t\t\t\t\t</a>*/
                        return '\t\t\t\t\t\t\t\t\t\t\t<a href="<?php echo base_url()."company/zone_validation/edit/";?>'+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t\t\t\t\t\t<a href="javascript:;" onclick="delete_zone_validation('+t.id+')" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" >\t\t\t\t\t\t\t<i class="la la-trash"></i>\t\t\t\t\t\t</a>'
                    }
                }]
            }),
            ...
            function delete_zone_validation(id) 
            {
                swal({   
                    title: "<?php echo $this->lang->line('label_are_you_sure') ?>",
                    text: "<?php echo $this->lang->line('label_you_want_to_delete_zone_validation') ?>",
                    type: "warning",   
                    ...
                    $.ajax({
                        url:  "<?php echo base_url(); ?>company/zone_validation/delete/"+id,
                        type: "GET",
