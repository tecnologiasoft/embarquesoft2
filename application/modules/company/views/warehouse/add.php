...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_add_new_warehouse'); ?>
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_add_new_warehouse'); ?>
                                </h3>
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('company/warehouse/add/',$form_data); 
                        ?>  
                            <div class="row">
                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="name" id="name" placeholder="<?php echo $this->lang->line('label_name'); ?>" value="<?php echo set_value('name'); ?>" >
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="m-radio-inline">
                                                            <label class="m-radio">
                                                                <input name="void" value="Yes" type="radio" checked="">
                                                                <?php echo $this->lang->line('label_yes'); ?>
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="void" value="No" type="radio" >
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="m-radio-inline">
                                                            <label class="m-radio">
                                                                <input name="status" value="A" type="radio" checked="">
                                                                A
                                                                <span></span>
                                                            </label>
                                                            <label class="m-radio">
                                                                <input name="status" value="N" type="radio" >
                                                                N
                                                                <span></span>
                                                            </label>
                                                        </div>
