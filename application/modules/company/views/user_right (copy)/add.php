...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_add_new_driver_right'); ?>
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_add_new_driver_right'); ?>
                                </h3>
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('company/driver_right/add/',$form_data); 
                        ?>  
                            <div class="row">
