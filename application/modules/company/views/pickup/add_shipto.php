...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            <?php echo $this->site_name; ?> | <?php echo $this->lang->line('title_add_new_shipto'); ?>
        </title>
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                    <?php echo $this->lang->line('title_add_new_shipto'); ?>
                                </h3>
                    ...
                    <div class="m-content">
                        ...
                        <?php 
                            ...
                            echo form_open('company/pickup/add_shipto/'.$user_result['id'],$form_data); 
                        ?>  
                            <div class="row">
                                <div class="col-xl-4">
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <!-- <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="address_line_3" id="route" placeholder="<?php echo $this->lang->line('label_address'); ?>" value="<?php echo set_value('address_line_3'); ?>" maxlength="256">
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" class="form-control m-input" name="shipto_cedula" id="shipto_cedula" placeholder="<?php echo $this->lang->line('label_shipto_cedula'); ?>" value="<?php echo set_value('shipto_cedula'); ?>" maxlength="20" required="">
                ...
                rules: {
                    ...
                    borough: {
                        required: function(element){
                            return ($("#country").val()!="Dominican Republic");
                        }
                    },
                    city: {
                        required: !0,
