<style>
    .form_label{
                        ...
                        <div class="row">
                            <div class="col-xl-12 offset-xl-2">
                                <div class="m-form__heading text-center">
                                    ...
                                    <h5 class="m-form__heading-title btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" onclick="hide_show_shipto();" id="title_customer_shipto">
                                        <?php echo $this->lang->line('label_ship_to'); ?> <i class="la la-angle-down" id="icon_customer_shipto_toggle"></i>
                                    </h5>
                                    <h5 class="m-form__heading-title btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" onclick="hide_show_pickup();" id="title_customer_pickup">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input ph" name="customer_telephone_number" id="customer_telephone_number" placeholder="<?php echo $this->lang->line('label_telephone_number'); ?>" value="<?php if(!empty($customer_details['telephone_number'])) echo $customer_details['telephone_number']; else echo set_value('customer_telephone_number'); ?>"> 
                                                            </div>
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input ph" name="customer_cellphone_number" id="customer_cellphone_number" placeholder="<?php echo $this->lang->line('label_cellphone_number'); ?>" value="<?php if(!empty($customer_details['cellphone_number'])) echo $customer_details['cellphone_number']; else echo set_value('customer_cellphone_number'); ?>"> 
                                                            </div>
                                                             ...
                                                             <label class="col-lg-5 col-form-label text-white mb-3 text-right">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="customer_office_phone_number ph" id="customer_office_phone_number" placeholder="<?php echo $this->lang->line('label_office_phone_number'); ?>" value="<?php if(!empty($customer_details['office_phone_number'])) echo $customer_details['office_phone_number']; else echo set_value('customer_office_phone_number'); ?>"> 
                                                                </div> 
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <label class="col-lg-5 col-form-label text-white mb-3 text-right">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input" name="apartment" id="apartment" placeholder="<?php echo $this->lang->line('apartment'); ?>" value="<?php if(!empty($customer_details['apartment'])) echo $customer_details['apartment']; else echo set_value('apartment'); ?>"> 
                                                            </div>
                                                    ...
                                                    <div class="col-lg-3 mb-3">
                                                        ...
                                                        <label class="col-lg-5 col-form-label text-white mb-3 text-right">
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <div class="col-lg-2" style = "margin-left: 173px;">
                                                                <input type = "hidden" name = "customer_id" value = "<?php echo $this->session->userdata('new_pickup_customer_id'); ?>">
                                                                    <button type="button" class="btn btn-success" value="update" id  = "update_customer_info">Submit</button>
                                                                </div>
                                                ...
                                                <div class="col-xl-8 order-2 order-xl-1" style="padding: 0 15px;">
                                                    <div class="form-group m-form__group row align-items-center">
                                                        ...
                                                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                            <a href="<?php echo site_url('company/customer/add_shipto/').$this->session->userdata('new_pickup_customer_id'); ?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                                <span>
                                    ...
                                    <div class="m-form__section m-form__section--first">
                                        <div class="m-portlet__body">
                                            ...
                                            <?php 
                                                ...
                                                echo form_open('company/pickup/add/',$form_data); 
                                            ?> 
                                            <input type = "hidden" name = "shipto_id" id = "shipto_id" value = "">
                                                ...
                                                <div class = "row">
                                                    <div class="col-lg-3">
                                                       <div class = "row">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input" name="pickup_id" id="pickup_id" placeholder="<?php echo $this->lang->line('label_pickup_id'); ?>" value="<?php echo set_value('pickup_id', $next_id); ?>" maxlength="20" readonly > 
                                                            ...
                                                            <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="cellphone_number" id="cellphone_number" placeholder="<?php echo $this->lang->line('label_cellphone_number'); ?>" value="<?php if(!empty($customer_pickup_details['cellphone_number'])) echo $customer_pickup_details['cellphone_number']; else echo set_value('cellphone_number'); ?>" data-parsley-trigger="focusin focusout"    data-parsley-required-if="#telephone_number" data-parsley-validate-if-empty="true"> 
                                                    ...
                                                    <div class="col-lg-3">
                                                       <div class="row">     
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="fname" id="fname" placeholder="<?php echo $this->lang->line('label_first_name'); ?>" value="<?php if(!empty($customer_pickup_details['fname'])) echo $customer_pickup_details['fname']; else echo set_value('fname'); ?>" maxlength="64"  required data-parsley-trigger="focusin focusout">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="lname" id="lname" placeholder="<?php echo $this->lang->line('label_last_name'); ?>" value="<?php if(!empty($customer_pickup_details['lname'])) echo $customer_pickup_details['lname']; else echo set_value('lname'); ?>" maxlength="64"  required data-parsley-trigger="focusin focusout">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input" name="address_line_1" id="address_line_1" placeholder="<?php echo $this->lang->line('label_address_1'); ?>" value="<?php if(!empty($customer_pickup_details['address_line1'])) echo $customer_pickup_details['address_line1']; else echo set_value('address_line_1'); ?>"  maxlength ="255"> 
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input" name="apartment" id="apartment" placeholder="<?php echo $this->lang->line('apartment'); ?>" value="<?php if(!empty($customer_pickup_details['apartment'])) echo $customer_pickup_details['apartment']; else echo set_value('apartment'); ?>"  maxlength ="255"> 
                                                        ...
                                                        <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="address_line_2" id="address_line_2" placeholder="<?php echo $this->lang->line('label_address_2'); ?>" value="<?php if(!empty($customer_pickup_details['address_line2'])) echo $customer_pickup_details['address_line2']; else echo set_value('address_line_2'); ?>"  maxlength ="255">  
                                                        ...
                                                        <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="city" id="pickup_city" placeholder="<?php echo $this->lang->line('label_city'); ?>" value="<?php if(!empty($customer_pickup_details['city'])) echo $customer_pickup_details['city']; else echo set_value('city'); ?>"  required data-parsley-trigger="focusin focusout"> 
                                                        ...
                                                        <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control m-input" name="state" id="pickup_state" placeholder="<?php echo $this->lang->line('label_state'); ?>" value="<?php if(!empty($customer_pickup_details['state'])) echo $customer_pickup_details['state']; else echo set_value('state'); ?>" required data-parsley-trigger="focusin focusout"> 
                                                            ...
                                                            <label class="form_label text-right col-lg-5 col-form-label col-form-label-right mb-3">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <input type="text" class="form-control m-input" name="zipcode" id="pickup_zipcode" placeholder="<?php echo $this->lang->line('label_zipcode'); ?>" value="<?php if(!empty($customer_pickup_details['zipcode'])) echo $customer_pickup_details['zipcode']; else echo set_value('zipcode'); ?>"  required data-parsley-trigger="focusin focusout"> 
                                                ...
                                                <div class="m-portlet__body"  style="border: 1px solid #b4bfd2; margin-top: 5px; border-radius: 10px; overflow:hidden;">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="item_1" id="item_1" placeholder="<?php echo $this->lang->line('label_item_1'); ?>" value="<?php echo set_value('item_1'); ?>" maxlength="32"  required data-parsley-trigger="focusin focusout"> 
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="item_2" id="item_2" placeholder="<?php echo $this->lang->line('label_item_2'); ?>" value="<?php echo set_value('item_2'); ?>" maxlength="32"  data-parsley-trigger="focusin focusout"> 
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="pickup_date" id="pickup_date" placeholder="<?php echo $this->lang->line('label_pickup_date'); ?>" value="<?php echo set_value('pickup_date'); ?>" maxlength="32"  required data-parsley-trigger="focusin focusout"> 
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="pickup_time" id="pickup_time" placeholder="<?php echo $this->lang->line('label_pickup_time'); ?>" value="<?php echo set_value('pickup_time'); ?>" maxlength="32"  data-parsley-trigger="focusin focusout"> 
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <select class="form-control m-input" name="driver_id" id="driver_id" placeholder="<?php echo $this->lang->line('label_driver'); ?>"  data-parsley-trigger="focusin focusout" data-parsley-errors-container="#driver_error">
                                                                ...
                                                                ?>
                                                                            <option value="<?php echo $value['id']; ?>" <?=set_value('driver_id') == $value['id']?'Selected':''?>><?php echo $value['fname']." ".$value['lname']; ?></option>
                                                                <?php
                                                                        }
                                                                    }
                                                                ?>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="boxes" id="boxes" placeholder="<?php echo $this->lang->line('label_total_box'); ?>" value="<?php echo set_value('boxes'); ?>" maxlength="10"  data-parsley-trigger="focusin focusout"> 
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input type="text" class="form-control m-input" name="barrels" id="barrels" placeholder="<?php echo $this->lang->line('label_total_barrel'); ?>" value="<?php echo set_value('pickup_time'); ?>" maxlength="10"  data-parsley-trigger="focusin focusout"> 
                                                    ...
                                                    <div class="form-group m-form__group row" style = "margin-top:-25px;">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <select class="form-control m-input" name="zone" id="zone" placeholder="<?php echo $this->lang->line('label_zone'); ?>">
                                                                ...
                                                                ?>
                                                                            <option value="<?php echo $value['id']; ?>" <?=set_value('zone') == $value['id']?'Selected':''?>><?php echo $value['description']; ?></option>
                                                                <?php
                                                                        }
                                                                    }
                                                                ?>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <select class = "form-control" name = "status" required data-parsley-trigger="focusin focusout">
                                                               ...
                                                               <option value = "Done" <?=set_value('status') == 'Done'?'Selected':''?>><?php echo $this->lang->line('label_done'); ?></option>
                                                               <option value = "Not Done"<?=set_value('status') == 'Not Done'?'Selected':''?>><?php echo $this->lang->line('label_not_done'); ?></option>
                                                               <option value = "Cancel"<?=set_value('status') == 'Cancel'?'Selected':''?>><?php echo $this->lang->line('label_cancel'); ?></option>
                                                               <option value = "Rescheduled"<?=set_value('status') == 'Rescheduled'?'Selected':''?>><?php echo $this->lang->line('label_rescheduled'); ?></option>
                                                            </select>
        ...
        <!--begin::Page Snippets -->
        <script src="<?php echo MAP_API_URL; ?>"></script>
                        ...
                        data: {
                            ...
                            source: {
                                read: {
                                    ...
                                    method: 'GET',
                                    params: {
                                        customer_id: "<?php echo $this->session->userdata('new_pickup_customer_id'); ?>"
                                    }
                                }, 
                            }, 
                            pageSize: 10,
