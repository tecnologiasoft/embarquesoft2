...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			<?php echo "embarquesoft"; ?>  | <?php echo $this->lang->line('title_invoice_details'); ?>
		</title>
						...
						<div class="row">
							...
							<div class="col-xl-12 col-lg-12">
								<div class="tab-pane active" id="m_user_profile_tab_3" aria-expanded="true">
                                    <div class="mm_datatable m-datatable m-datatable--default m-datatable--loaded" id="ajax_data" style="">
                                    	<table class="m-datatable__table" id="m-datatable--178233019980" style="display: block; height: auto; overflow-x: auto;">
                                    		<thead class="m-datatable__head">
                                    			<tr class="m-datatable__row" style="height: 39px;">
                                    				<th data-field="id" class="m-datatable__cell--center m-datatable__cell m-datatable__cell--sort"><span style="width: 50px;">#</span></th>
                                    				<th data-field="invoice_number" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Invoice Id</span></th>
                                    				<th data-field="sub_total" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Total Amount</span></th>
                                    				<th data-field="payments" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Paid Amount</span></th>
                                    				<th data-field="final_balance" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Balance</span></th>
                                    				<th data-field="invoice_date" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Payment Date</span></th>
                                    				<th data-field="invoice_date" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Transaction Id</span></th>
                                    				<th data-field="invoice_date" class="m-datatable__cell m-datatable__cell--sort"><span style="width: 221px;">Receipt No.</span></th>
                                    		...
                                    		<tbody class="m-datatable__body" style="">
                                    			...
                                    			foreach ($result['data'] as $key => $value) {
                                    				...
                                    				<td data-field="invoice_number" class="m-datatable__cell">
                                    					<span style="width: 100px;"><?php echo $a;?></span>
                                    				</td>
                                    				<td data-field="invoice_number" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->invoice_id;?></span>
                                    				</td>
                                    				<td data-field="sub_total" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->amount;?></span>
                                    				</td>
                                    				<td data-field="payments" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->payed;?></span>
                                    				</td>
                                    				<td data-field="final_balance" class="m-datatable__cell">
                                    					<span style="width: 221px;">
                                    						<span><?php echo $value->balance;?></span>
                                    					</span>
                                    				</td>
                                    				<td data-field="invoice_date" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->payment_date;?></span>
                                    				</td>
                                    				<td data-field="invoice_date" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->transaction_id;?></span>
                                    				</td>
                                    				<td data-field="invoice_date" class="m-datatable__cell">
                                    					<span style="width: 221px;"><?php echo $value->receipt_number;?></span>
                                    				</td>
