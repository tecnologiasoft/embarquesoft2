                                        ...
                                        <div class="col-xl-8 order-2 order-xl-1">
                                            <div class="form-group m-form__group row align-items-center">
                                                ...
                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                    <a href="<?php echo $this->rights->access('company/inventory/add');?>" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                                        <span>
                                                            <i class="la la-plus"></i> 
                                                            <span>
                                                                <?php echo $this->lang->line('label_add_inventory'); ?>
                                                            </span>
                                                        </span>
                                                    </a>
        ...
        <script type="text/javascript">
            ...
            var t = $(".m_datatable").mDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: "<?php echo site_url('company/inventory/ajax_list')?>"
                        }
                    },
                    pageSize: 10,
                    saveState: {
                ...
                columns: [{
                    ...
                    textAlign: "center",
                    template: function(t) {
                        <?php if($this->rights->access('company/inventory/edit/') != 'javascript:void(0);') {?>
                        return '\t\t\t\t\t\t\t\t\t\t\t<a href="<?php echo base_url()."company/inventory/edit/";?>'+t.id+'" class="">\t\t\t\t\t\t\t'+t.id+'\t\t\t\t\t\t</a>'
                        <?php } ?>
                    }
                }, {
                    field: "item_number",
                    title: "<?php echo $this->lang->line('label_item_number'); ?>",
                }, {
                    field: "description",
                    title: "<?php echo $this->lang->line('label_description'); ?>",
                }, {
                    field: "price",
                    title: "<?php echo $this->lang->line('label_price'); ?>",
                }, {
                    field: "cost",
                    title: "<?php echo $this->lang->line('label_cost'); ?>",
                },{
                    field: "type",
                    title: "<?php echo $this->lang->line('label_type'); ?>",
                },{
                    field: "qty",
                    title: "<?php echo $this->lang->line('label_qty'); ?>",
                },
                {
                    field: "Actions",
                    width: 110,
            ...
            function delete_inventory(id) 
            {
                swal({   
                    ...
                    text: "<?php echo $this->lang->line('label_you_want_to_delete_inventory') ?>",
                    type: "warning",   
                    ...
                    $.ajax({
                        url:  "<?php echo base_url(); ?>company/inventory/delete/"+id,
                        type: "GET",
